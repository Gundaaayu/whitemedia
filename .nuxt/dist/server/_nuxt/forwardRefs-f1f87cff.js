import { ref, readonly, createVNode, capitalize, computed, h, mergeProps, Transition, shallowRef, watch, nextTick, withDirectives, Fragment, resolveDirective, vShow, isRef, unref, toRefs, toRef, Text, resolveDynamicComponent, TransitionGroup, camelize } from "vue";
import { C as includes, p as propsFactory, f as getCurrentInstance, g as genericComponent, s as useRtl, D as breakpoints, q as convertToUnit, S as SUPPORTS_INTERSECTION, t as getCurrentInstanceName, F as destructComputed, G as isCssColor, H as isParsableColor, J as parseColor, K as getForeground, e as provideDefaults, I as IconValue, m as makeThemeProps, d as provideTheme, L as useIcon, M as flattenFragments, N as hasEvent, O as isObject, P as keyCodes } from "../server.mjs";
...
export {
  ...
  nullifyTransforms as I,
  animate as J,
  VExpandXTransition as K,
  standardEasing as L,
  MaybeTransition as M,
  Intersect$1 as N,
  forwardRefs as O,
  deceleratedEasing as P,
  acceleratedEasing as Q,
  Ripple as R,
  getTargetBox as S,
  VExpandTransition as T,
  parseAnchor as U,
  VContainer as V,
  flipSide as W,
  flipAlign as X,
  ...
  makeElevationProps as f,
  makeRoundedProps as g,
  makeTagProps as h,
  ...
  useSize as p,
  useTextColor as q,
  useResizeObserver as r,
  makeLocationProps as s,
  useLocation as t,
  useDensity as u,
  useBackgroundColor as v,
  makeDimensionProps as w,
  makePositionProps as x,
  makeRouterProps as y,
  useVariant as z
};
//# sourceMappingURL=forwardRefs-f1f87cff.js.map
