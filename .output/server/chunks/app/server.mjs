import { version as version$1, unref, inject as inject$1, Fragment, reactive, computed, watchEffect, toRefs, capitalize, warn, ref, provide, defineComponent as defineComponent$1, getCurrentInstance as getCurrentInstance$1, createVNode, mergeProps, watch, onScopeDispose, toRaw, h, shallowReactive, Suspense, nextTick, Transition, hasInjectionContext, shallowRef, effectScope, useSSRContext, createApp, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, toRef, isReadonly, isRef, isShallow, isReactive, withCtx } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-15ac2415.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-cdb9588e.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-6d23afbf.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-7fc8a7b7.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-7520c43f.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { IN_BROWSER as $, filterInputAttrs as A, callEvent as B, includes as C, breakpoints as D, EventProp as E, destructComputed as F, isCssColor as G, isParsableColor as H, IconValue as I, parseColor as J, getForeground as K, useIcon as L, flattenFragments as M, hasEvent as N, isObject as O, keyCodes as P, eventName as Q, defineComponent as R, SUPPORTS_INTERSECTION as S, deprecate as T, focusChild as U, getPropertyFromItem as V, omit as W, consoleError as X, clamp as Y, refElement as Z, _export_sfc as _, useRuntimeConfig as a, matchesSelector as a0, focusableChildren as a1, getNextElement as a2, navigateTo as b, createError as c, provideTheme as d, entry$1 as default, provideDefaults as e, getCurrentInstance as f, genericComponent as g, getUid as h, injectHead as i, useProxiedModel as j, deepEqual as k, findChildrenWithProvide as l, makeThemeProps as m, nuxtLinkDefaults as n, consoleWarn as o, propsFactory as p, convertToUnit as q, resolveUnrefHeadInput as r, useRtl as s, getCurrentInstanceName as t, useRouter as u, useLocale as v, wrapInArray as w, isOn as x, pick as y, useToggleScope as z };
